        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 overflow-x-auto">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th className="border-b py-3 px-6">Name</th>
              <th className="border-b py-3 px-6">Email</th>
              <th className="border-b py-3 px-6">Phone</th>
              <th className="border-b py-3 px-6">Message</th>
          ...
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="border-b py-4 px-6">Deni Irawan Nugraha</td>
              <td className="border-b py-4 px-6">deni.irawan@lumoshive.co</td>
              <td className="border-b py-4 px-6">083174869601</td>
              <td className="border-b py-4 px-6">
                consectetur adipisicing elit. Reprehenderit, architecto ab
                molestias, quasi, fuga fugiat ipsa consectetur doloremque
                inventore veritatis explicabo at error maiores tempore rem totam
                animi provident in.
              </td>
