    ...
    <>
      <div className="container mx-auto px-10 pt-10">
        <div className="relative overflow-x-auto p-4 bg-white rounded-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
          <h1 className="text-2xl font-bold text-gray-600 dark:text-white mb-10">
            Dashboard
          </h1>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              <FaUser className="text-primary text-4xl m-4" />
            ...
            <Link
              ...
              className="flex flex-col items-center bg-white-100 border
               ...
               md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
            >
              <FaBriefcase className="text-primary text-4xl m-4" />
              <div className="flex flex-col justify-between p-4 leading-normal">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-600 dark:text-white">
                  Portofolio
                </h5>
            ...
            <Link
              ...
              className="flex flex-col items-center bg-white-100 border
               ...
               md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
            >
              <FaUsers className="text-primary text-4xl m-4" />
              <div className="flex flex-col justify-between p-4 leading-normal">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-600 dark:text-white">
                  Teams
                </h5>
            ...
            <Link
              ...
              className="flex flex-col items-center bg-white-100 border
               ...
               md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
            >
              <FaRegNewspaper className="text-primary text-4xl m-4" />
              <div className="flex flex-col justify-between p-4 leading-normal">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-600 dark:text-white">
                  Article
                </h5>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-5 items-center">
            <Link
              ...
              className="flex flex-col items-center bg-white-100 border
               ...
               md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
            >
              <FaEnvelope className="text-primary text-4xl m-4" />
              <div className="flex flex-col justify-between p-4 leading-normal">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-600 dark:text-white">
                  Contact
                </h5>
            ...
            <Link
              ...
              className="flex flex-col items-center bg-white-100 border
               ...
               md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
            >
              <FaBell className="text-primary text-4xl m-4" />
              <div className="flex flex-col justify-between p-4 leading-normal">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-600 dark:text-white">
                  Subcribe Email
                </h5>
